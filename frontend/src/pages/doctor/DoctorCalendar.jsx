...
const DoctorCalendar = () => {
  ...
  }, [user?.doctorId, currentDate, filter]);
  ...
  }, [user, currentDate, filter, fetchAppointments]);
  ...
  const getAppointmentsForDate = (date) => {
    ...
    return appointments.filter((apt) => {
      ...
      const aptDateStr = `${aptDate.getFullYear()}-${String(
        aptDate.getMonth() + 1
                    ...
                    <div
                      ...
                      <div className="flex gap-2 ml-4">
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            navigate(`/doctor/patients/${apt.patientId}`)
                          }
