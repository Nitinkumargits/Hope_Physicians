...
const Appointments = () => {
  ...
  const fetchAppointments = async () => {
    console.log('🔍 Fetching appointments...', { user, doctorId: user?.doctorId });
    ...
    try {
      ...
      const result = await doctorService.getAllAppointments(user.doctorId, filters);
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">
                {!user ? 'User not logged in' : 'Doctor ID not found. Please log out and log in again.'}
              </p>
            </div>
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-primary-50 rounded-lg">
                  ...
                  <p className="font-semibold text-gray-900">{selectedPatient.appointmentType}</p>
                </div>
                
                <div className="p-4 bg-primary-50 rounded-lg">
                  <p className="text-sm text-gray-500 mb-1">Date & Time</p>
                  <p className="font-semibold text-gray-900">
                    {selectedPatient.appointmentDate} at {selectedPatient.appointmentTime}
                  </p>
                </div>
                ...
                {selectedPatient.appointmentNotes && (
                  <div className="p-4 bg-primary-50 rounded-lg md:col-span-2">
                    ...
                    <p className="font-semibold text-gray-900">{selectedPatient.appointmentNotes}</p>
                  </div>
                )}
              </div>
            </div>
