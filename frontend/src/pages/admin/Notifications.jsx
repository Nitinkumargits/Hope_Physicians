...
import { FaBell, FaSpinner, FaCheck, FaTimes, FaExclamationCircle } from 'react-icons/fa';
      ...
      setNotifications([
        {
          ...
          message: 'Robert Taylor has submitted KYC documents',
          type: 'kyc',
          status: 'unread',
        ...
        },
        {
          ...
          message: 'John Doe cancelled appointment scheduled for today',
          type: 'appointment',
          status: 'unread',
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                      <FaExclamationCircle className={`w-5 h-5 ${getPriorityColor(notif.priority).split(' ')[0]}`} />
