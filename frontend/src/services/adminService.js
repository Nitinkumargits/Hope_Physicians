...
export const getDashboardStats = async () => {
  try {
    const response = await axios.get(`${API_BASE}/admin/stats`, { timeout: 3000 });
...
export const getEmployees = async (params = {}) => {
  try {
    const response = await axios.get(`${API_BASE}/admin/employees`, { params, timeout: 3000 });
    return response.data;
  } catch (error) {
    // Fallback to mock data if API is not available or returns 404
    if (error.code === 'ECONNREFUSED' || error.response?.status === 404 || error.message.includes('Network Error')) {
...
export const getPatients = async (params = {}) => {
  try {
    const response = await axios.get(`${API_BASE}/admin/patients`, { params, timeout: 3000 });
    return response.data;
  } catch (error) {
    // Fallback to mock data if API is not available or returns 404
    if (error.code === 'ECONNREFUSED' || error.response?.status === 404 || error.message.includes('Network Error')) {
...
export const getDoctors = async (params = {}) => {
  try {
    const response = await axios.get(`${API_BASE}/admin/doctors`, { params, timeout: 3000 });
    return response.data;
  } catch (error) {
    // Fallback to mock data if API is not available or returns 404
    if (error.code === 'ECONNREFUSED' || error.response?.status === 404 || error.message.includes('Network Error')) {
...
export const getAppointments = async (params = {}) => {
  try {
    const response = await axios.get(`${API_BASE}/admin/appointments`, { params, timeout: 3000 });
    return response.data;
  } catch (error) {
    // Fallback to mock data if API is not available or returns 404
    if (error.code === 'ECONNREFUSED' || error.response?.status === 404 || error.message.includes('Network Error')) {
...
export const reviewKYC = async (kycId, action, remark = '') => {
  try {
    const response = await axios.post(`${API_BASE}/admin/kyc/${kycId}/review`, { action, remark }, { timeout: 3000 });
    return response.data;
  } catch (error) {
...
export const getAttendance = async (params = {}) => {
  try {
    const response = await axios.get(`${API_BASE}/admin/attendance`, { params, timeout: 3000 });
    return response.data;
  } catch (error) {
    // Fallback to mock data if API is not available or returns 404
    if (error.code === 'ECONNREFUSED' || error.response?.status === 404 || error.message.includes('Network Error')) {
